...
Beyond LCA applications, the GeoPolRisk method can be used as a comparative risk assessment tool for companies and organizations [@Koyamparambath2022]. With an automated calculation tool, users can input their specific supply mix to calculate tailored supply risk scores. This feature can benefit companies seeking to analyze different supply risk scenarios based on their unique supply chains and compare their risk with national averages.
